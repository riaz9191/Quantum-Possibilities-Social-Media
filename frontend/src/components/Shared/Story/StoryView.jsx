...
import { FaArrowLeft, FaArrowRight, FaTimes, FaEllipsisH } from 'react-icons/fa';
// import { useHistory } from 'react-router-dom';

const stories = [
  // Add your story data here
  { id: 1, name: 'Ayesha Akter Mitu', time: '21 hour', image: 'https://via.placeholder.com/50', mainImage: 'https://s3-alpha-sig.figma.com/img/0d63/5630/71ee0be67a603e99a26544662f2b5442?Expires=1721001600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=JRFqL855BK5JIx4zmncZBryQ9MWYuNPNotaJ2GI-B-ps1OkibiJE7cCP-f-BPTtFSoA5dFALj--YsFGj4RSqd2~WWEhyDIE7IIz1xg180r4zsvr6EtwE778YfYZ8I3joP40EXoocG1v~bxMBgGHd2p0q0EvV~WuFZa1m8p0ROS8ZXze0Cg0FjdHNtCwITjGBW3XgiFawHe7mP3Xe-Fpcjmp37REWlqSYYedU0dNawJd95eLqplwIk3hTcksYogUInF~T2wnr0Mlym4S03HiOK5zwRX2KSc4WHCQ6W4-7k0ojCiqsBOznCItvUK4FHW95Rr4VjBPIyeoK88fBwofCig__' },
...
//   const history = useHistory();
  ...
  return (
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="w-1/4 bg-white p-4 overflow-y-auto">
        ...
        {stories.map((story) => (
          <div key={story.id} className="flex items-center mb-4 cursor-pointer" onClick={() => setSelectedStory(story)}>
            <img src={story.image} alt={story.name} className="w-10 h-10 rounded-full mr-4" />
            <div>
  ...
  <div className="w-full max-w-lg relative">
    <div className="absolute top-4 left-4 flex items-center">
      <img src={selectedStory.image} alt={selectedStory.name} className="w-10 h-10 rounded-full mr-2" />
    ...
    <div className="absolute top-0 left-0 w-full h-2 bg-gray-800">
      <div className="h-full bg-[#307777]" style={{ animation: 'progress 15s linear forwards' }}></div>
    </div>
    <img src={selectedStory.mainImage} alt="Main Story" className="w-full h-full object-cover rounded-lg" />
